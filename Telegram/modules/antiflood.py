...
@user_admin_no_reply
@bot_admin
@zaidcallback(pattern=r"unmute_flooder")
...
@zaid(command="flood", filters=Filters.chat_type.groups)
@connection_status
...
@zaid(command="setfloodmode", pass_args=True, filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
